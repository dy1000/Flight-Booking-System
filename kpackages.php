        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center">
                <div class="inner-column">
                    <h1>4 nights in Kenya <span>$270</span></h1>
...
<div class="cards">
    ...
    <article class="card">
        ...
        <img src="images/hemingways.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Stay at the Hemingways hotel which is luxurious and rated 5 stars!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/talisman.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Dine at the Talisman which has fantastic food!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/mountk.jpg"  alt="Hot air balloons">
        <div class="content">
            <p>Taking a trip to the mountains is a wonderful way to experience the beauty and nature of Kenya.</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/lamu.jpg"alt="Hot air balloons">
        <div class="content">
            <p> The Lamu festival in Kenya is one of the Africa's most famous festivals, housing an extensive collection of ancient Kenyan tradition. </p>
        </div>
...
<div class="page">
    <div class="timeline">
        <div class="timeline__group">
            <span class="timeline__year time" aria-hidden="true">Kenya Itinerary</span>
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Check in at Hemingways Hotel.</p>
                       <p> 1:00pm - Tour bus around the capital city!</p>
                        <p> 5:00pm - Dinner at the hotel. </p>
                ...
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Visit to Mount Kilimanjaro.</p>
                        <p> 1:00pm - Explore the stunning landscape of the Maasai Mara.</p>
                        <p> 3:00pm - Stay overnight at a luxury tented camp.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Visit the Sheldrick Elephant Orphanage.</p>
                        <p> 1:00pm - Explore the city of Mombasa and enjoy a sunset dinner at the beach.</p>
                        <p> 7:00pm - Dine at our fabulous Talisman restaurant.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            ...
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Visit the Lamu festival.</p>
                    </div>
                </div>
            </div>
        </div>
