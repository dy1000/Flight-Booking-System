        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center">
                <div class="inner-column">
                    <h1>4 nights in Morocco <span>$290</span></h1>
...
<div class="cards">
    ...
    <article class="card">
        ...
        <img src="images/royal.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Stay at the Royal hotel which is luxurious and rated 5 stars!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/maison.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Dine at the La Maison which has fantastic food!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/hiking.jpg"  alt="Hot air balloons">
        <div class="content">
            <p>Taking a trip up the Atlas Mountains is a wonderful way to experience the beauty and nature of Morocco.</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/national.jpg"alt="Hot air balloons">
        <div class="content">
            <p> The Marrakech arts festival in Morocco is one of the countries most famous festivals. </p>
        </div>
...
<div class="page">
    <div class="timeline">
        <div class="timeline__group">
            <span class="timeline__year time" aria-hidden="true">Morocco Itinerary</span>
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Check in at Royal Hotel</p>
                       <p> 1:00pm - Spend the morning exploring the souks of Marrakech</p>
                        <p> 3:00pm - Camel ride out to the desert for a magical sunset.  </p>
                ...
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Take a day trip to the coastal city of Essaouira.</p>
                        <p> 3:00pm - Explore the old medina and the ramparts. Spend the afternoon relaxing on the beach.</p>
        ...
        <div class="timeline__group">
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Head up to the Atlas Mountains and hike to beautiful Berber villages.</p>
                        <p> 7:00pm - Dine at our fabulous La Maison.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            ...
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Attend the national festival</p>
                        <p> 3:00pm - Spend your final evening at a rooftop bar, watching the sunset over the city.</p>
                    </div>
                </div>
            </div>
        </div>
