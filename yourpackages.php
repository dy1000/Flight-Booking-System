...
if (isset($_GET['id'])){
    $user_id = $_GET['id'];
    $select = "SELECT * FROM packages where user_id = '$user_id'";
...
if (isset($_POST['cancel'])){
    $user_id = $_POST['id'];
    $delete = "DELETE FROM packages WHERE user_id = '$user_id'";
    $result = mysqli_query($conn, $delete) or die("An error has occurred! " .mysqli_error($conn));
    header('location:yourpackages.php?id='.$user_id);
}
?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center py-4">
                <div class="inner-column">
                    <h1 style="text-align: left">Packages <span></span></h1>
                    <ul style="font-size: 22px; text-align: left;">

                        <li>
                            <strong> Package:</strong> <?php echo $data['package'];?>
                        </li>
                        <li>
                            <strong> Passengers:</strong>    <?php echo $data['people'] != null ?$data['people']: 0;?>
                        </li>
                        <li>
                            <strong>Nights </strong> <?php echo $data['nights'];?>
                        </li>
                        <li>
                            <strong>Date: </strong>  <?php echo $data['dates'];?>
                        </li>
                        <li>
                            <form action="yourpackages.php?id=<?php echo $data['user_id'];?>"method="post">
