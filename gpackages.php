        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center">
                <div class="inner-column">
                    <h1>4 nights in Ghana <span>$290</span></h1>
...
<div class="cards">
    ...
    <article class="card">
        ...
        <img src="images/labadi.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Stay at the Labadi beach hotel which is luxurious and rated 5 stars!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/senchi.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Dine at the Royal senchi restaurant which has fantastic food!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/quad.jpg"  alt="Hot air balloons">
        <div class="content">
            <p>Take a trip up the mountains on quad bikes!.</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/elmina.jpg"alt="Hot air balloons">
        <div class="content">
            <p> Visit the Elmina Castle and learn about the history of our ancestors.  </p>
        </div>
...
<div class="page">
    <div class="timeline">
        <div class="timeline__group">
            <span class="timeline__year time" aria-hidden="true">Ghana Itinerary</span>
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Check in at Labadi beach Hotel.</p>
                       <p> 1:00pm - Stroll around the beach. Horse riding on the beach. and Quad biking</p>
                        <p> 3:00pm - Dinner kebab.</p>
                ...
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Visit the Kwame Nkrumah memorial park.</p>
                        <p> 1:00pm - Visit the Elmina Castle</p>
                        <p> 7:00pm - Dine at the Royal senchi. </p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Jet ski at Aqua Safari.</p>
                        <p> 1:00pm - Swimming in hotel pool.</p>
                        <p> 7:00pm - Party at Kruna night club. </p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            ...
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Quad biking on Aburi mountain.</p>
                        <p> 1:00pm - Day party at Aburi.</p>
                    </div>
                </div>
            </div>
        </div>
