        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center">
                <div class="inner-column">
                    <h1>4 nights in Seychelles <span>$300</span></h1>
...
<div class="cards">
    ...
    <article class="card">
        ...
        <img src="images/four.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Stay at the Four seasons hotel which is luxurious and rated 5 stars!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/ombre.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Dine at the Ombre which has fantastic food!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/fishing.jpg"  alt="Hot air balloons">
        <div class="content">
            <p>Taking a cruise into the seychelles sea is a wonderful way to experience the beauty of Seychelles.</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/arts.jpg"alt="Hot air balloons">
        <div class="content">
            <p> The Seychelles Arts Festival is an annual event that celebrates the vibrant culture and heritage of the Seychelles islands. Held in March. </p>
        </div>
...
<div class="page">
    <div class="timeline">
        <div class="timeline__group">
            <span class="timeline__year time" aria-hidden="true">Seychelles Itinerary</span>
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Check in at Four seasons Hotel</p>
                       <p> 1:00pm - Have lunch at Mahek Restaurant. Explore the unique forests and see the Coco de mer palms </p>
                        <p>3:00pm - Enjoy the sunset at the Anse Source d'Argent Beach </p>
                ...
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Go island hopping and visit Curieuse Island</p>
                        <p> 1:00pm - Go kayaking and have a picnic at Anse Marie-Louise</p>
        ...
        <div class="timeline__group">
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Visit the Vallée de Mai Nature Reserve</p>
                        <p> 1:00pm - Grab lunch at La Cocoteraie</p>
                        <p> 7:00pm - Dine at our fabulous Ombre Hotel. </p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            ...
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Go snorkeling and explore the coral reefs.</p>
                        <p> 1:00pm - Attend the Seychelles arts festival.</p>
                    </div>
                </div>
            </div>
        </div>
