        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center">
                <div class="inner-column">
                    <h1>4 nights in Egypt <span>$270</span></h1>
...
<div class="cards">
    ...
    <article class="card">
        ...
        <img src="images/plaza.jpg" class="image-size" alt="Hot air balloons">
        <div class="content">
            <p> Stay at the Plaza hotel which is luxurious and rated 5 stars!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/naguib.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Dine at the Naguib which has fantastic food!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/ncruise.jpg"  alt="Hot air balloons">
        <div class="content">
            <p>Taking a cruise down the Nile River is a wonderful way to experience the beauty and history of Egypt.</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/musuem.jpg"alt="Hot air balloons">
        <div class="content">
            <p> The Egyptian Museum in Cairo is one of the world's most famous museums, housing an extensive collection of ancient Egyptian artifacts. </p>
        </div>
...
<div class="page">
    <div class="timeline">
        <div class="timeline__group">
            <span class="timeline__year time" aria-hidden="true">Egypt Itineray</span>
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Check in at Plaza Hotel</p>
                       <p> 1:00pm - Visit the Great Pyramids of Giza</p>
                        <p> 3:00pm - Camel ride at the beach followed by swimming and boat ride. </p>
                ...
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Cruise around the river nile</p>
                        <p> 1:00pm - Visit the valley of the Kings and Queens. Visit the Temple of Hatshepsut in Deir el-Bahari.</p>
        ...
        <div class="timeline__group">
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Visit the ancient Temple of Philae</p>
                        <p> 1:00pm - Visit the Nubian villages</p>
                        <p> 7:00pm - Dine at our fabulous Naguib Hotel </p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            ...
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Visit the Egyptian musuem</p>
                        <p> 1:00pm - Visit the Mediterranean Sea</p>
                    </div>
                </div>
            </div>
        </div>
