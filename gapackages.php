        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-center">
                <div class="inner-column">
                    <h1>4 nights in Gambia <span>$300</span></h1>
...
<div class="cards">
    ...
    <article class="card">
        ...
        <img src="images/coco.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Stay at the Coco hotel which is luxurious and rated 5 stars!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/afrikan.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Dine at the Afrikan which has fantastic food!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/birds.jpg"  alt="Hot air balloons">
        <div class="content">
            <p>Taking a trip to the Jungle is a wonderful way to experience the beauty and nature of Gambia.</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/jrra.jpg"alt="Hot air balloons">
        <div class="content">
            <p> The Jarra festival in Gambia is one of the Africa's most famous festivals, housing an extensive collection of ancient Gambian tradition. </p>
        </div>
...
<div class="page">
    <div class="timeline">
        <div class="timeline__group">
            <span class="timeline__year time" aria-hidden="true">Gambia Itinerary</span>
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Check in at Coconut Hotel</p>
                       <p> 1:00pm - Visit the beach. Stroll around the beacj followed by a boat trip.</p>
                        <p> 3:00pm - Camel ride </p>
                ...
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Morning beach trip.</p>
                        <p> 1:00pm - Quad Biking.</p>
                        <p> 7:00pm - Dine at the Afrikan restaurant.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Bird Watching.</p>
                        <p> 1:00pm - Visit Abuko nature reserve.</p>
                        <p> 7:00pm - Visit Museum. </p>
                    </div>
                </div>
            </div>
        </div>
        <div class="timeline__group">
            ...
            <div class="timeline__cards">
                <div class="timeline__card card">
                    ...
                    <div class="card__content">
                        <p>9:00am - Annual Jarra festival.</p>
                        <p> 1:00pm - Boat trip.</p>
                    </div>
                </div>
            </div>
        </div>
