    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <img src="images/packages.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-lg-6 col-md-6 text-center">
                <div class="inner-column">
                    <h1>4 nights in Nigeria <span>$285</span></h1>
...
<div class="ptitle">
    <h2> Our Specialised Itinerary</h2>
</div>
<div class="cards">
    ...
    <article class="card">
        ...
        <img src="images/eko.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Stay at the Eko hotel which is luxurious and rated 5 stars!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/nok.jpg" alt="Hot air balloons">
        <div class="content">
            <p> Dine at the Nok by Alara which has fantastic food!</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/kayak.jpg"  alt="Hot air balloons">
        <div class="content">
            <p>Taking a cruise down the Lagos Lagoon is a wonderful way to experience the beauty of Nigeria.</p>
        </div>
    ...
    <article class="card">
        ...
        <img src="images/carni.jpg"alt="Hot air balloons">
        <div class="content">
            <p> The Lagos Carnival in Nigeria is one of the countries most famous festivals, housing an extensive collection of events. </p>
        </div>
...
<div class="page">
    <div class="timeline">
        <div class="timeline__group">
            <span class="timeline__year time" aria-hidden="true">Nigeria Itinerary</span>
            <div class="timeline__cards">
                <div class="timeline__card card">
                    <header class="card__header">
                        <time class="time" datetime="2008-02-02">
                            <span class="time__day">Day</span>
                            <span class="time__month">1</span>
                        </time>
                    </header>
                    <div class="card__content">
                        <p>9:00am - Check in at Eko Hotel.</p>
                        <p>1:00pm - Start the day with a visit to the National Museum.</p>
                        <p>5:00pm - Head to the popular Bar Beach for a relaxing afternoon of sunbathing and swimming. </p>
                ...
                <div class="timeline__card card">
                    <header class="card__header">
                        <time class="time" datetime="2008-09-01">
                            <span class="time__day">Day</span>
                            <span class="time__month">2</span>
                        </time>
                        <h3 class="card__title r-title"></h3>
                    </header>
                    <div class="card__content">
                        <p>9:00am - Visit the Lekki Conservation Centre to learn more about the local wildlife and enjoy the beautiful scenery of the rainforest.</p>
                        <p>1:00pm - Lagos Arts and Crafts Market for a unique shopping experience.</p>
                        <p>5:00pm - End the day with a stroll through the lively Victoria Island area.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="timeline__card card">
                    <header class="card__header">
                        <time class="time" datetime="2008-07-14">
                            <span class="time__day">Day</span>
                            <span class="time__month">3</span>
                        </time>
                    </header>
                    <div class="card__content">
                        <p>9:00am - Tarkwa Bay beach, which is great for surfing and other watersports.</p>
                        <p> 7:00pm - Dine at our fabulous Nok by Alara. </p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="timeline__card card">
                    <header class="card__header">
                        <time class="time" datetime="2008-08-18">
                            <span class="time__day">Day</span>
                            <span class="time__month">4</span>
                        </time>
                    </header>
                    <div class="card__content">
                        <p>9:00am - Visit the Lagos Carnival.</p>
                        <p> 1:00pm - Last stroll around the city.</p>
                    </div>
                </div>
            </div>
        </div>
